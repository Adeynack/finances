...
#                                                 /cable                                                                                            #<ActionCable::Server::Base:0x0000000113a456f0 @config=#<ActionCable::Server::Configuration:0x0000000113a04f88 @log_tags=[], @connection_class=#<Proc:0x0000000113a17f48 /Users/adeynack/.rbenv/versions/3.1.4/lib/ruby/gems/3.1.0/gems/actioncable-7.0.6/lib/action_cable/engine.rb:46 (lambda)>, @worker_pool_size=4, @disable_request_forgery_protection=false, @allow_same_origin_as_host=true, @logger=#<ActiveSupport::Logger:0x00000001130c9838 @level=0, @progname=nil, @default_formatter=#<Logger::Formatter:0x00000001130c9d10 @datetime_format=nil>, @formatter=#<ActiveSupport::Logger::SimpleFormatter:0x00000001130c9720 @datetime_format=nil>, @logdev=#<Logger::LogDevice:0x00000001130c9b58 @shift_period_suffix="%Y%m%d", @shift_size=1048576, @shift_age=0, @filename="/Users/adeynack/src/github.com/Adeynack/finances/log/test.log", @dev=#<File:/Users/adeynack/src/github.com/Adeynack/finances/log/test.log>, @binmode=false, @mon_data=#<Monitor:0x00000001130c9ab8>, @mon_data_owner_object_id=9340>>, @cable={"adapter"=>"test"}, @mount_path="/cable", @precompile_assets=true>, @mutex=#<Monitor:0x0000000113a45650>, @pubsub=nil, @worker_pool=nil, @event_loop=nil, @remote_connections=nil>
