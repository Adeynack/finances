...
#                                                 /cable                                                                                            #<ActionCable::Server::Base:0x00000001134a1c30 @config=#<ActionCable::Server::Configuration:0x00000001134286a0 @log_tags=[], @connection_class=#<Proc:0x000000011341ae60 /Users/adeynack/.rbenv/versions/3.1.2/lib/ruby/gems/3.1.0/gems/actioncable-7.0.3.1/lib/action_cable/engine.rb:46 (lambda)>, @worker_pool_size=4, @disable_request_forgery_protection=false, @allow_same_origin_as_host=true, @logger=#<ActiveSupport::Logger:0x0000000112338548 @level=0, @progname=nil, @default_formatter=#<Logger::Formatter:0x0000000112339060 @datetime_format=nil>, @formatter=#<ActiveSupport::Logger::SimpleFormatter:0x0000000112338458 @datetime_format=nil>, @logdev=#<Logger::LogDevice:0x0000000112338c78 @shift_period_suffix="%Y%m%d", @shift_size=1048576, @shift_age=0, @filename="/Users/adeynack/src/github.com/Adeynack/finances_rebirth/log/development.log", @dev=#<File:/Users/adeynack/src/github.com/Adeynack/finances_rebirth/log/development.log>, @binmode=false, @mon_data=#<Monitor:0x0000000112338ac0>, @mon_data_owner_object_id=57560>>, @cable={"adapter"=>"async"}, @mount_path="/cable", @precompile_assets=true, @allowed_request_origins=/https?:\/\/localhost:\d+/>, @mutex=#<Monitor:0x00000001134a1b90>, @pubsub=nil, @worker_pool=nil, @event_loop=nil, @remote_connections=nil>
