...
#                                                 /cable                                                                                            #<ActionCable::Server::Base:0x0000000113a0a668 @config=#<ActionCable::Server::Configuration:0x00000001139684f8 @log_tags=[], @connection_class=#<Proc:0x0000000113950c18 /Users/adeynack/.rbenv/versions/3.1.4/lib/ruby/gems/3.1.0/gems/actioncable-7.0.6/lib/action_cable/engine.rb:46 (lambda)>, @worker_pool_size=4, @disable_request_forgery_protection=false, @allow_same_origin_as_host=true, @logger=#<ActiveSupport::Logger:0x0000000113bf9e38 @level=0, @progname=nil, @default_formatter=#<Logger::Formatter:0x0000000113bfa310 @datetime_format=nil>, @formatter=#<ActiveSupport::Logger::SimpleFormatter:0x0000000113bf9d20 @datetime_format=nil>, @logdev=#<Logger::LogDevice:0x0000000113bfa158 @shift_period_suffix="%Y%m%d", @shift_size=1048576, @shift_age=0, @filename="/Users/adeynack/src/github.com/Adeynack/finances/log/test.log", @dev=#<File:/Users/adeynack/src/github.com/Adeynack/finances/log/test.log>, @binmode=false, @mon_data=#<Monitor:0x0000000113bfa0b8>, @mon_data_owner_object_id=9340>>, @cable={"adapter"=>"test"}, @mount_path="/cable", @precompile_assets=true>, @mutex=#<Monitor:0x0000000113a0a528>, @pubsub=nil, @worker_pool=nil, @event_loop=nil, @remote_connections=nil>
