...
#                                                 /cable                                                                                            #<ActionCable::Server::Base:0x0000000115a11bf0 @config=#<ActionCable::Server::Configuration:0x000000011598bf00 @log_tags=[], @connection_class=#<Proc:0x000000011597bbc8 /Users/adeynack/.rbenv/versions/3.1.4/lib/ruby/gems/3.1.0/gems/actioncable-7.0.4.3/lib/action_cable/engine.rb:46 (lambda)>, @worker_pool_size=4, @disable_request_forgery_protection=false, @allow_same_origin_as_host=true, @logger=#<ActiveSupport::Logger:0x0000000115eb0e68 @level=0, @progname=nil, @default_formatter=#<Logger::Formatter:0x0000000115eb1d40 @datetime_format=nil>, @formatter=#<ActiveSupport::Logger::SimpleFormatter:0x0000000115eb0378 @datetime_format=nil>, @logdev=#<Logger::LogDevice:0x0000000115eb19d0 @shift_period_suffix="%Y%m%d", @shift_size=1048576, @shift_age=0, @filename="/Users/adeynack/src/github.com/Adeynack/finances/log/development.log", @dev=#<File:/Users/adeynack/src/github.com/Adeynack/finances/log/development.log>, @binmode=false, @mon_data=#<Monitor:0x0000000115eb1908>, @mon_data_owner_object_id=9120>>, @cable={"adapter"=>"async"}, @mount_path="/cable", @precompile_assets=true, @allowed_request_origins=/https?:\/\/localhost:\d+/>, @mutex=#<Monitor:0x0000000115a11650>, @pubsub=nil, @worker_pool=nil, @event_loop=nil, @remote_connections=nil>
