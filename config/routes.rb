...
#                                                 /cable                                                                                            #<ActionCable::Server::Base:0x00000001157fd008 @config=#<ActionCable::Server::Configuration:0x0000000115629178 @log_tags=[], @connection_class=#<Proc:0x000000011570f8f8 /Users/adeynack/.rbenv/versions/3.1.4/lib/ruby/gems/3.1.0/gems/actioncable-7.0.6/lib/action_cable/engine.rb:46 (lambda)>, @worker_pool_size=4, @disable_request_forgery_protection=false, @allow_same_origin_as_host=true, @logger=#<ActiveSupport::Logger:0x00000001161874e8 @level=0, @progname=nil, @default_formatter=#<Logger::Formatter:0x00000001161879c0 @datetime_format=nil>, @formatter=#<ActiveSupport::Logger::SimpleFormatter:0x00000001161873d0 @datetime_format=nil>, @logdev=#<Logger::LogDevice:0x0000000116187808 @shift_period_suffix="%Y%m%d", @shift_size=1048576, @shift_age=0, @filename="/Users/adeynack/src/github.com/Adeynack/finances/log/test.log", @dev=#<File:/Users/adeynack/src/github.com/Adeynack/finances/log/test.log>, @binmode=false, @mon_data=#<Monitor:0x0000000116187768>, @mon_data_owner_object_id=9340>>, @cable={"adapter"=>"test"}, @mount_path="/cable", @precompile_assets=true>, @mutex=#<Monitor:0x00000001157fcf18>, @pubsub=nil, @worker_pool=nil, @event_loop=nil, @remote_connections=nil>
