...
class User
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `User` class because it declared `has_many :books`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Book::PrivateCollectionProxy) }
    def books; end
    ...
    def build_default_book(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::Book) }
    def create_default_book(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::Book) }
    def create_default_book!(*args, &blk); end

    sig { returns(T.nilable(::Book)) }
    def default_book; end

    sig { params(value: T.nilable(::Book)).void }
    def default_book=(value); end

    sig { returns(T.nilable(::Book)) }
    def reload_default_book; end
  end
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T.untyped) }
    def default_book_id; end

    sig { params(value: T.untyped).returns(T.untyped) }
    def default_book_id=(value); end

    sig { returns(T::Boolean) }
    def default_book_id?; end

    sig { returns(T.untyped) }
    def default_book_id_before_last_save; end

    sig { returns(T.untyped) }
    def default_book_id_before_type_cast; end

    sig { returns(T::Boolean) }
    def default_book_id_came_from_user?; end

    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def default_book_id_change; end

    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def default_book_id_change_to_be_saved; end

    sig { returns(T::Boolean) }
    def default_book_id_changed?; end

    sig { returns(T.untyped) }
    def default_book_id_in_database; end

    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def default_book_id_previous_change; end

    sig { returns(T::Boolean) }
    def default_book_id_previously_changed?; end

    sig { returns(T.untyped) }
    def default_book_id_previously_was; end

    sig { returns(T.untyped) }
    def default_book_id_was; end

    sig { void }
    def default_book_id_will_change!; end
    ...
    sig { void }
    def restore_default_book_id!; end
    ...
    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def saved_change_to_default_book_id; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_default_book_id?; end
