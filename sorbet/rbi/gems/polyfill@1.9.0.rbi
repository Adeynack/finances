...
module Polyfill
  ...
  class << self
    # source://polyfill//lib/polyfill.rb#63
    def get(module_name, methods, options = T.unsafe(nil)); end
  end
end
...
module Polyfill::InternalUtils
  ...
  class << self
    # source://polyfill//lib/polyfill/internal_utils.rb#97
    def create_module(*args); end

    # source://polyfill//lib/polyfill/internal_utils.rb#15
    def current_ruby_version; end

    # source://polyfill//lib/polyfill/internal_utils.rb#25
    def ignore_warnings; end

    # source://polyfill//lib/polyfill/internal_utils.rb#46
    def keep_only_these_methods!(mod, whitelist); end

    # source://polyfill//lib/polyfill/internal_utils.rb#84
    def methods_to_keep(modules, methods, lead_symbol, module_name); end

    # source://polyfill//lib/polyfill/internal_utils.rb#72
    def modules_to_use(module_name, versions); end

    # source://polyfill//lib/polyfill/internal_utils.rb#108
    def namify_arguments(*args); end

    # source://polyfill//lib/polyfill/internal_utils.rb#39
    def polyfill_versions_to_use(desired_version = T.unsafe(nil)); end

    # source://polyfill//lib/polyfill/internal_utils.rb#147
    def to_f(obj); end

    # source://polyfill//lib/polyfill/internal_utils.rb#160
    def to_hash(obj); end

    # source://polyfill//lib/polyfill/internal_utils.rb#134
    def to_int(obj); end

    # source://polyfill//lib/polyfill/internal_utils.rb#121
    def to_str(obj); end
  end
end
