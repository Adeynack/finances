...
# @api private
#
# source://slim//lib/slim/embedded.rb#214
class Slim::Embedded::JavaScriptEngine < ::Slim::Embedded::TagEngine
  # @api private
  #
  # source://slim//lib/slim/embedded.rb#219
...
class Slim::Embedded::RubyEngine < ::Slim::Embedded::Engine
  # @api private
  #
  # source://slim//lib/slim/embedded.rb#226
  def on_slim_embedded(engine, body, attrs); end
end
...
class Slim::Embedded::TagEngine < ::Slim::Embedded::Engine
  # @api private
  #
  # source://slim//lib/slim/embedded.rb#190
  def on_slim_embedded(engine, body, attrs); end
end
...
class Slim::Parser < ::Temple::Parser
  ...
  # @api private
  #
  # source://slim//lib/slim/parser.rb#404
  def parse_attributes(attributes = T.unsafe(nil)); end

  # @api private
  #
  # source://slim//lib/slim/parser.rb#317
  def parse_broken_line; end

  # @api private
  #
  # source://slim//lib/slim/parser.rb#267
  ...
  # @api private
  #
  # source://slim//lib/slim/parser.rb#491
  def parse_quoted_attribute(quote); end

  # @api private
  #
  # source://slim//lib/slim/parser.rb#463
  def parse_ruby_code(outer_delimiter); end

  # @api private
  #
  # source://slim//lib/slim/parser.rb#326
  def parse_tag(tag); end

  # @api private
  #
  # source://slim//lib/slim/parser.rb#274
  ...
  # @api private
  #
  # source://slim//lib/slim/parser.rb#513
  ...
  # @api private
  #
  # source://slim//lib/slim/parser.rb#263
...
# @api public
#
# source://slim//lib/slim/railtie.rb#2
...
class Slim::Splat::Builder
  ...
  # @api private
  #
  # source://slim//lib/slim/splat/builder.rb#107
...
class Slim::Splat::Filter < ::Slim::Filter
  # @api private
  #
  # source://slim//lib/slim/splat/filter.rb#9
  def call(exp); end
  ...
  # @return [Array] Compiled temple expression
  #
  # source://slim//lib/slim/splat/filter.rb#46
  def on_html_attrs(*attrs); end
  ...
  # @return [Array] Compiled temple expression
  #
  # source://slim//lib/slim/splat/filter.rb#26
  ...
  # @api private
  #
  # source://slim//lib/slim/splat/filter.rb#67
  def make_builder(attrs); end

  # @api private
  # @return [Boolean]
  #
  # source://slim//lib/slim/splat/filter.rb#59
  def splat?(attr); end
end
