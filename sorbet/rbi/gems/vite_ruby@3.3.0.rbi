...
class ViteRuby
  ...
  #
  # source://vite_ruby//lib/vite_ruby.rb#119
  def builder; end

  # Internal: Helper to run commands related with Vite.
  #
  # source://vite_ruby//lib/vite_ruby.rb#124
  def commands; end

  # Public: Current instance configuration for Vite.
  #
  # source://vite_ruby//lib/vite_ruby.rb#129
  def config; end

  # Public: Allows overriding the configuration for this instance.
  #
  # source://vite_ruby//lib/vite_ruby.rb#139
  ...
  #
  # source://vite_ruby//lib/vite_ruby.rb#101
  def env; end
  ...
  #
  # source://vite_ruby//lib/vite_ruby.rb#144
  def manifest; end

  # Internal: Executes the vite binary.
  #
  # source://vite_ruby//lib/vite_ruby.rb#114
  ...
  # @return [Boolean]
  #
  # source://vite_ruby//lib/vite_ruby.rb#106
  def run_proxy?; end
...
class ViteRuby::Manifest
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#69
  def lookup!(name, **options); end
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#121
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#114
  def manifest; end
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#205
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#172
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#143
  ...
  # @return [Boolean]
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#97
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#186
