...
class ReverseMarkdown::Converters::Base
  ...
  # source://reverse_markdown//lib/reverse_markdown/converters/base.rb#43
  def extract_src(node); end

  # source://reverse_markdown//lib/reverse_markdown/converters/base.rb#38
  ...
  #
  # source://reverse_markdown//lib/reverse_markdown/converters/base.rb#20
  def wrap_with_markers(content, marker); end
end
...
class ReverseMarkdown::Converters::Text < ::ReverseMarkdown::Converters::Base
  ...
  # @return [Boolean]
  #
  # source://reverse_markdown//lib/reverse_markdown/converters/text.rb#70
  def has_adjacent_inline_content?(node, direction); end

  # source://reverse_markdown//lib/reverse_markdown/converters/text.rb#93
  ...
  def remove_border_newlines(text, node); end

  # source://reverse_markdown//lib/reverse_markdown/converters/text.rb#89
  def remove_inner_newlines(text); end

  # source://reverse_markdown//lib/reverse_markdown/converters/text.rb#19
  def treat_empty(node); end

  # source://reverse_markdown//lib/reverse_markdown/converters/text.rb#33
  def treat_text(node); end
end

# source://reverse_markdown//lib/reverse_markdown/converters/text.rb#14
ReverseMarkdown::Converters::Text::INLINE_ELEMENTS = T.let(T.unsafe(nil), Array)
