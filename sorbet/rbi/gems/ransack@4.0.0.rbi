...
class ActionView::Helpers::Tags::Base
  ...
  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#12
  def initialize(object_name, method_name, template_object, options = T.unsafe(nil)); end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#10
  def object; end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#32
  def render; end

  private

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#95
  def add_default_name_and_id(options); end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#82
  def add_default_name_and_id_for_value(tag_value, options); end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#147
  def add_options(option_tags, options, value = T.unsafe(nil)); end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#173
  def generate_ids?; end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#165
  def name_and_id_index(options); end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#142
  def placeholder_required?(html_options); end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#73
  def retrieve_autoindex(pre_match); end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#62
  def retrieve_object(object); end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#115
  def sanitized_method_name; end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#119
  def sanitized_value(value); end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#123
  def select_content_tag(option_tags, options, html_options); end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#111
  def tag_id(index = T.unsafe(nil), namespace = T.unsafe(nil)); end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#107
  def tag_name(multiple = T.unsafe(nil), index = T.unsafe(nil)); end

  # source://ransack//lib/ransack/helpers/form_builder.rb#10
  def value; end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#45
  def value_before_type_cast; end

  # source://actionview/7.0.4.3/lib/action_view/helpers/tags/base.rb#57
...
class Ransack::Context
  ...
  # source://ransack//lib/ransack/context.rb#123
  ...
  # source://ransack//lib/ransack/context.rb#89
  ...
  # @return [Boolean]
  #
  # source://ransack//lib/ransack/context.rb#163
  def ransackable_association?(str, klass); end

  # @return [Boolean]
  #
  # source://ransack//lib/ransack/context.rb#158
  def ransackable_attribute?(str, klass); end

  # @return [Boolean]
  #
  # source://ransack//lib/ransack/context.rb#167
  def ransackable_scope?(str, klass); end

  # @return [Boolean]
  #
  # source://ransack//lib/ransack/context.rb#171
  def ransackable_scope_skip_sanitize_args?(str, klass); end

  # source://ransack//lib/ransack/context.rb#85
  ...
  # source://ransack//lib/ransack/context.rb#183
  def searchable_associations(str = T.unsafe(nil)); end

  # source://ransack//lib/ransack/context.rb#175
  def searchable_attributes(str = T.unsafe(nil)); end

  # source://ransack//lib/ransack/context.rb#179
...
class Ransack::Helpers::FormHelper::SortLink
  ...
  # source://ransack//lib/ransack/helpers/form_helper.rb#219
  def default_sort_order(attr_name); end

  # source://ransack//lib/ransack/helpers/form_helper.rb#206
  def detect_previous_sort_direction_and_invert_it(attr_name); end

  # source://ransack//lib/ransack/helpers/form_helper.rb#238
  def direction_text(dir); end

  # source://ransack//lib/ransack/helpers/form_helper.rb#214
  ...
  # source://ransack//lib/ransack/helpers/form_helper.rb#224
  def order_indicator; end

  # source://ransack//lib/ransack/helpers/form_helper.rb#155
  def parameters_hash(params); end

  # source://ransack//lib/ransack/helpers/form_helper.rb#198
  def parse_sort(field); end

  # source://ransack//lib/ransack/helpers/form_helper.rb#193
  ...
  # source://ransack//lib/ransack/helpers/form_helper.rb#187
  def sort_params; end
end
...
class Ransack::Nodes::Condition < ::Ransack::Nodes::Node
  ...
  # source://ransack//lib/ransack/nodes/condition.rb#286
  ...
  # @return [Boolean]
  #
  # source://ransack//lib/ransack/nodes/condition.rb#341
  def casted_array?(predicate); end

  # source://ransack//lib/ransack/nodes/condition.rb#318
  def combinator_method; end

  # source://ransack//lib/ransack/nodes/condition.rb#322
  def format_predicate(attribute); end

  # source://ransack//lib/ransack/nodes/condition.rb#345
  def format_values_for(predicate); end

  # @return [Boolean]
  #
  # source://ransack//lib/ransack/nodes/condition.rb#336
  def in_predicate?(predicate); end

  # @return [Boolean]
  #
  # source://ransack//lib/ransack/nodes/condition.rb#351
  def replace_right_node?(predicate); end

  # @return [Boolean]
  #
  # source://ransack//lib/ransack/nodes/condition.rb#362
...
class Ransack::Search
  ...
  #
  # source://ransack//lib/ransack/search.rb#22
  def initialize(object, params = T.unsafe(nil), options = T.unsafe(nil)); end

  # Returns the value of attribute base.
  #
  # source://ransack//lib/ransack/search.rb#15
  def base; end

  # source://ransack//lib/ransack/search.rb#47
  def build(params); end
  ...
  # source://ransack//lib/ransack/search.rb#92
  ...
  # source://ransack//lib/ransack/search.rb#118
  def inspect; end

  # source://ransack//lib/ransack/search.rb#17
  def klass(*_arg0, **_arg1, &_arg2); end

  # source://ransack//lib/ransack/search.rb#102
  def method_missing(method_id, *args); end
  ...
  # source://ransack//lib/ransack/search.rb#133
  def add_scope(key, args); end

  # source://ransack//lib/ransack/search.rb#162
  def collapse_multiparameter_attributes!(attrs); end

  # source://ransack//lib/ransack/search.rb#148
...
# source://ransack//lib/ransack.rb#7
