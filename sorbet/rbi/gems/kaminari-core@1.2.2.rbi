...
module Kaminari::Helpers::HelperMethods
  ...
  #   <% end %>
  #
  # source://kaminari-core//lib/kaminari/helpers/helper_methods.rb#153
...
class Kaminari::Helpers::Paginator < ::Kaminari::Helpers::Tag
  ...
  #
  # source://kaminari-core//lib/kaminari/helpers/paginator.rb#50
  def each_page; end
  ...
  # source://kaminari-core//lib/kaminari/helpers/paginator.rb#66
...
module Kaminari::Helpers::UrlHelper
  ...
  # It will return `nil` if there is no next page.
  #
  # source://kaminari-core//lib/kaminari/helpers/helper_methods.rb#79
  ...
  #
  # source://kaminari-core//lib/kaminari/helpers/helper_methods.rb#95
  ...
  # It will return `nil` if there is no previous page.
  #
  # source://kaminari-core//lib/kaminari/helpers/helper_methods.rb#94
  ...
  # It will return `nil` if there is no previous page.
  #
  # source://kaminari-core//lib/kaminari/helpers/helper_methods.rb#93
  ...
  # It will return `nil` if there is no previous page.
  #
  # source://kaminari-core//lib/kaminari/helpers/helper_methods.rb#63
  ...
  # It will return `nil` if there is no next page.
  #
  # source://kaminari-core//lib/kaminari/helpers/helper_methods.rb#44
  ...
  # It will return `nil` if there is no previous page.
  #
  # source://kaminari-core//lib/kaminari/helpers/helper_methods.rb#64
  ...
  # It will return `nil` if there is no previous page.
  #
  # source://kaminari-core//lib/kaminari/helpers/helper_methods.rb#65
...
class Kaminari::PaginatableArray < ::Array
  ...
  # source://kaminari-core//lib/kaminari/models/array_extension.rb#11
  def limit_value; end
  ...
  # source://kaminari-core//lib/kaminari/models/array_extension.rb#42
