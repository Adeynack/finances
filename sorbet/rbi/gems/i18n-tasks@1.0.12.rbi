...
module I18n::Tasks::Configuration
  ...
  #
  # source://i18n-tasks//lib/i18n/tasks/configuration.rb#80
  def base_locale; end
  ...
  # source://i18n-tasks//lib/i18n/tasks/configuration.rb#119
  ...
  # source://i18n-tasks//lib/i18n/tasks/configuration.rb#98
  def ignore_config(type = T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/configuration.rb#84
  def internal_locale; end

  # @return [Array<String>] all available locales, base_locale is always first
  #
  # source://i18n-tasks//lib/i18n/tasks/configuration.rb#75
  def locales; end
  ...
  # source://i18n-tasks//lib/i18n/tasks/configuration.rb#129
...
# source://i18n-tasks//lib/i18n/tasks/configuration.rb#103
...
module I18n::Tasks::Data::Adapter::YamlAdapter
  class << self
    # @return [String]
    #
    # source://i18n-tasks//lib/i18n/tasks/data/adapter/yaml_adapter.rb#22
    def dump(tree, options); end

    # @return [Hash] locale tree
    #
    # source://i18n-tasks//lib/i18n/tasks/data/adapter/yaml_adapter.rb#12
    def parse(str, options); end

    # @return [String]
    #
    # source://i18n-tasks//lib/i18n/tasks/data/adapter/yaml_adapter.rb#27
...
module I18n::Tasks::KeyPatternMatching
  ...
  #
  # source://i18n-tasks//lib/i18n/tasks/key_pattern_matching.rb#25
  ...
  # source://i18n-tasks//lib/i18n/tasks/key_pattern_matching.rb#31
...
# @since 0.9.0
#
# source://i18n-tasks//lib/i18n/tasks/scanners/files/caching_file_finder.rb#13
...
#
# source://i18n-tasks//lib/i18n/tasks/scanners/ruby_ast_scanner.rb#11
class I18n::Tasks::Scanners::RubyAstScanner < ::I18n::Tasks::Scanners::FileScanner
  ...
  # @return [nil, [key, Occurrence]] full absolute key name and the occurrence.
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/ruby_ast_scanner.rb#101
  ...
  # @return [nil, [key, Occurrence]] full absolute key name and the occurrence.
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/ruby_ast_scanner.rb#68
  def comments_to_occurences(path, ast, comments); end

  # @return [Boolean]
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/ruby_ast_scanner.rb#46
  ...
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/ruby_ast_scanner.rb#56
  ...
  # @return [{Parser::AST::Node}, [Parser::Source::Comment]]
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/ruby_ast_scanner.rb#41
  def path_to_ast_and_comments(path); end
  ...
  # @return [Array<[key, Results::KeyOccurrence]>] each occurrence found in the file
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/ruby_ast_scanner.rb#29
  def scan_file(path); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/ruby_ast_scanner.rb#114
  def setup_matchers; end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/ruby_ast_scanner.rb#15
...
# @since 0.9.0
#
# source://i18n-tasks//lib/i18n/tasks/scanners/scanner_multiplexer.rb#10
...
# source://i18n-tasks//lib/i18n/tasks/translation.rb#8
module I18n::Tasks::Translation
  ...
  #
  # source://i18n-tasks//lib/i18n/tasks/translation.rb#13
...
class I18n::Tasks::Translators::BaseTranslator
  ...
  # @return [I18n::Tasks::Tree::Siblings] translated forest
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#14
  ...
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#66
  def dump_value(value); end

  # @param list [Array<[String, Object]>] of key-value pairs
  # @return [Array<[String, Object]>] translated list
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#43
  ...
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#58
  def from_values(list, translated_values); end

  # @abstract
  # @return [String]
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#153
  def no_results_error_message; end

  # @abstract
  # @return [Hash]
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#145
  def options_for_html; end

  # @abstract
  # @return [Hash]
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#149
  ...
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#80
  ...
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#51
  def to_values(list); end

  # @param list [Array<[String, Object]>] of key-value pairs
  # @return [Array<[String, Object]>] translated list
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#25
  ...
  # @return [Array<String>]
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#136
  def translate_values(list, **options); end
end

# source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#96
I18n::Tasks::Translators::BaseTranslator::INTERPOLATION_KEY_RE = T.let(T.unsafe(nil), Regexp)

# source://i18n-tasks//lib/i18n/tasks/translators/base_translator.rb#97
...
class I18n::Tasks::Translators::DeeplTranslator < ::I18n::Tasks::Translators::BaseTranslator
  ...
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/deepl_translator.rb#7
  def initialize(*_arg0); end

  protected

  # source://i18n-tasks//lib/i18n/tasks/translators/deepl_translator.rb#57
  def no_results_error_message; end

  # source://i18n-tasks//lib/i18n/tasks/translators/deepl_translator.rb#32
  def options_for_html; end

  # source://i18n-tasks//lib/i18n/tasks/translators/deepl_translator.rb#36
  def options_for_plain; end

  # source://i18n-tasks//lib/i18n/tasks/translators/deepl_translator.rb#28
  def options_for_translate_values(**options); end
  ...
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/deepl_translator.rb#49
  def restore_interpolations(untranslated, translated); end

  # source://i18n-tasks//lib/i18n/tasks/translators/deepl_translator.rb#19
  ...
  # Convert 'es-ES' to 'ES'
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/deepl_translator.rb#64
