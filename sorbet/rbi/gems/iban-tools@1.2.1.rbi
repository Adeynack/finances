...
class IBANTools::Conversion
  class << self
    # source://iban-tools//lib/iban-tools/conversion.rb#71
    def bban_format_cast(format, value); end

    # source://iban-tools//lib/iban-tools/conversion.rb#46
    def bban_format_length(format); end

    # source://iban-tools//lib/iban-tools/conversion.rb#54
    def bban_format_to_format_string(format); end

    # source://iban-tools//lib/iban-tools/conversion.rb#83
    def bban_format_to_regexp(format); end

    # source://iban-tools//lib/iban-tools/conversion.rb#111
    def checksum(country_code, bban); end

    # source://iban-tools//lib/iban-tools/conversion.rb#25
    def iban2local(country_code, bban); end

    # source://iban-tools//lib/iban-tools/conversion.rb#102
...
# source://iban-tools//lib/iban-tools/conversion.rb#44
IBANTools::Conversion::BBAN_REGEXP = T.let(T.unsafe(nil), Regexp)
