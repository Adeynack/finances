...
class ActiveRecord::Base
  ...
  # source://ransack/4.0.0/lib/ransack/adapters/active_record/base.rb#9
  ...
  # source://ransack/4.0.0/lib/ransack/adapters/active_record/base.rb#8
  def _ransackers; end
...
class ActiveStorage::Blob < ::ActiveStorage::Record
  ...
  # source://actiontext/7.0.4.3/lib/action_text/engine.rb#43
  ...
  # source://actiontext/7.0.4.3/lib/action_text/engine.rb#39
  def previewable_attachable?; end

  def purge; end
  def purge_later; end

  # source://activerecord/7.0.4.3/lib/active_record/secure_token.rb#39
  ...
  # source://actiontext/7.0.4.3/lib/action_text/engine.rb#47
