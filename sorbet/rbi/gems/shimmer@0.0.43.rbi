...
# source://shimmer//lib/shimmer/auth/user.rb#14
...
class Shimmer::Config
  ...
  # source://shimmer//lib/shimmer/utils/config.rb#34
  def stub(**values); end

  private

  # source://shimmer//lib/shimmer/utils/config.rb#43
  def coerce(value, type); end

  # @return [Boolean]
  #
  # source://shimmer//lib/shimmer/utils/config.rb#30
  def respond_to_missing?(method_name, include_all); end

  class << self
    private

    # source://shimmer//lib/shimmer/utils/config.rb#5
    def allocate; end
...
class Shimmer::ConsentSettings
  ...
  # source://shimmer//lib/shimmer/utils/consent_settings.rb#10
  def essential?; end
...
module Shimmer::FileAdditions
  ...
  def image_file_path(source, **_arg1); end

  # source://shimmer//lib/shimmer/utils/file_helper.rb#45
  def image_file_proxy(source, width: T.unsafe(nil), height: T.unsafe(nil), return_type: T.unsafe(nil)); end

  # source://shimmer//lib/shimmer/utils/file_helper.rb#41
  def image_file_url(source, **_arg1); end
...
class Shimmer::FileProxy
  ...
  #
  # source://shimmer//lib/shimmer/utils/file_proxy.rb#36
  def initialize(blob_id:, width: T.unsafe(nil), height: T.unsafe(nil)); end

  # source://shimmer//lib/shimmer/utils/file_proxy.rb#49
  def blob; end
  ...
  # source://shimmer//lib/shimmer/utils/file_proxy.rb#62
  def file; end
  ...
  # source://shimmer//lib/shimmer/utils/file_proxy.rb#41
  def path; end

  # source://shimmer//lib/shimmer/utils/file_proxy.rb#45
  def url(protocol: T.unsafe(nil)); end

  # source://shimmer//lib/shimmer/utils/file_proxy.rb#53
  def variant; end

  private

  # source://shimmer//lib/shimmer/utils/file_proxy.rb#68
  def id; end

  class << self
    # source://shimmer//lib/shimmer/utils/file_proxy.rb#31
    def message_verifier; end

    # source://shimmer//lib/shimmer/utils/file_proxy.rb#18
    def parse_resize(resize); end
...
class Shimmer::Form::CheckboxField < ::Shimmer::Form::Field
  ...
  class << self
    # source://shimmer//lib/shimmer/form/checkbox_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::CheckboxesField < ::Shimmer::Form::Field
  ...
  class << self
    # source://shimmer//lib/shimmer/form/checkboxes_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::DateField < ::Shimmer::Form::Field
  ...
  class << self
    # source://shimmer//lib/shimmer/form/date_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::DatetimeField < ::Shimmer::Form::Field
  ...
  class << self
    # source://shimmer//lib/shimmer/form/datetime_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::EmailField < ::Shimmer::Form::Field
  ...
  class << self
    ...
    # source://shimmer//lib/shimmer/form/email_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::ImageField < ::Shimmer::Form::Field
  ...
  class << self
    # source://shimmer//lib/shimmer/form/image_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::NumberField < ::Shimmer::Form::Field
  ...
  class << self
    # source://shimmer//lib/shimmer/form/number_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::PasswordField < ::Shimmer::Form::Field
  ...
  class << self
    ...
    # source://shimmer//lib/shimmer/form/password_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::PdfField < ::Shimmer::Form::Field
  ...
  class << self
    ...
    # source://shimmer//lib/shimmer/form/pdf_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::RadioField < ::Shimmer::Form::Field
  ...
  class << self
    # source://shimmer//lib/shimmer/form/radio_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::RadiosField < ::Shimmer::Form::Field
  ...
  class << self
    # source://shimmer//lib/shimmer/form/radios_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::SelectField < ::Shimmer::Form::Field
  ...
  class << self
    ...
    # source://shimmer//lib/shimmer/form/select_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::TextAreaField < ::Shimmer::Form::Field
  ...
  class << self
    # source://shimmer//lib/shimmer/form/text_area_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::TextField < ::Shimmer::Form::Field
  ...
  class << self
    # source://shimmer//lib/shimmer/form/text_field.rb#6
    def type; end
  end
end
...
class Shimmer::Form::TimeField < ::Shimmer::Form::Field
  ...
  class << self
    # source://shimmer//lib/shimmer/form/time_field.rb#6
    def type; end
  end
end
...
# source://shimmer//lib/shimmer/utils/remote_navigation.rb#7
class Shimmer::RemoteNavigation::RemoteNavigationError < ::StandardError; end

# source://shimmer//lib/shimmer/utils/remote_navigation.rb#65
class Shimmer::RemoteNavigator
  ...
  # source://shimmer//lib/shimmer/utils/remote_navigation.rb#108
  ...
  # source://shimmer//lib/shimmer/utils/remote_navigation.rb#132
  ...
  # source://shimmer//lib/shimmer/utils/remote_navigation.rb#124
  def open_popover(url, selector:, placement: T.unsafe(nil)); end

  # source://shimmer//lib/shimmer/utils/remote_navigation.rb#66
  ...
  # source://shimmer//lib/shimmer/utils/remote_navigation.rb#140
