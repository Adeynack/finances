...
module AmazingPrint
  class << self
    ...
    # source://amazing_print//lib/amazing_print/custom_defaults.rb#56
    def rdbg!; end

    # Reload the cached custom configurations.
    #
    # source://amazing_print//lib/amazing_print/custom_defaults.rb#88
    def reload!; end
    ...
    #
    # source://amazing_print//lib/amazing_print/custom_defaults.rb#97
...
module AmazingPrint::ActionView
  ...
  #
  # source://amazing_print//lib/amazing_print/ext/action_view.rb#20
...
module AmazingPrint::ActiveRecord
  ...
  # ------------------------------------------------------------------------------
  #
  # source://amazing_print//lib/amazing_print/ext/active_record.rb#93
  def awesome_active_model_class(object); end

  # Format ActiveModel error object.
  # ------------------------------------------------------------------------------
  #
  # source://amazing_print//lib/amazing_print/ext/active_record.rb#106
  def awesome_active_model_error(object); end

  # Format ActiveModel instance object.
  # ------------------------------------------------------------------------------
  #
  # source://amazing_print//lib/amazing_print/ext/active_record.rb#80
  def awesome_active_model_instance(object); end

  # Format ActiveRecord class object.
  # ------------------------------------------------------------------------------
  #
  # source://amazing_print//lib/amazing_print/ext/active_record.rb#67
  ...
  # ------------------------------------------------------------------------------
  #
  # source://amazing_print//lib/amazing_print/ext/active_record.rb#48
...
#
# source://amazing_print//lib/amazing_print/ext_loader.rb#8
class AmazingPrint::ExtLoader
  class << self
    # source://amazing_print//lib/amazing_print/ext_loader.rb#13
    def call; end
  end
end

# source://amazing_print//lib/amazing_print/ext_loader.rb#9
...
class AmazingPrint::Formatter
  ...
  # source://amazing_print//lib/amazing_print/ext/active_record.rb#11
  def cast_without_active_record(_object, type); end

  # source://amazing_print//lib/amazing_print/ext/active_support.rb#11
  def cast_without_active_support(object, type); end

  # source://amazing_print//lib/amazing_print/ext/nokogiri.rb#11
  def cast_without_nokogiri(object, type); end

  # source://amazing_print//lib/amazing_print/ext/ostruct.rb#11
  ...
  # source://amazing_print//lib/amazing_print/formatter.rb#94
...
class AmazingPrint::Formatters::ArrayFormatter < ::AmazingPrint::Formatters::BaseFormatter
  ...
  #
  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#13
  def initialize(array, inspector); end

  # Returns the value of attribute array.
  #
  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#11
  def array; end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#20
  def format; end
  ...
  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#64
  def array_prefix(iteration, width); end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#118
  def find_method(name); end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#54
  def generate_printable_array; end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#76
  def generate_printable_tuples; end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#109
  def generate_tuple(name); end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#134
  def generic_prefix(iteration, width, padding = T.unsafe(nil)); end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#68
  def methods_array; end

  # @return [Boolean]
  #
  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#32
  def methods_array?; end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#44
  def multiline_array; end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#99
  def name_and_args_width; end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#36
  def simple_array; end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#105
  def tuple_prefix(iteration, width); end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#84
  def tuple_template(item); end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#95
  def tuples; end

  # source://amazing_print//lib/amazing_print/formatters/array_formatter.rb#142
  def width(items); end
end
...
class AmazingPrint::Formatters::HashFormatter < ::AmazingPrint::Formatters::BaseFormatter
  ...
  #
  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#15
  def hash; end
  ...
  # @return [Boolean]
  #
  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#117
  def json_format?; end

  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#121
  def json_syntax(key, value, width); end

  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#83
  def key_size(key); end

  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#77
  def left_width(keys); end

  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#93
  def max_key_width(keys); end

  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#49
  ...
  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#148
  def plain_single_line(&_arg0); end

  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#143
  def pre_ruby19_syntax(key, value, width); end

  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#57
  def printable_hash; end

  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#97
  def printable_keys; end

  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#133
  def ruby19_syntax(key, value, width); end

  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#53
  def simple_hash; end

  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#156
  def single_line; end

  # @return [Boolean]
  #
  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#109
  def string?(key); end

  # @return [Boolean]
  #
  # source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#113
  def symbol?(key); end
end

# source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#13
class AmazingPrint::Formatters::HashFormatter::InvalidHashFormatError < ::StandardError; end

# source://amazing_print//lib/amazing_print/formatters/hash_formatter.rb#11
...
class AmazingPrint::Formatters::StructFormatter < ::AmazingPrint::Formatters::BaseFormatter
  ...
  # source://amazing_print//lib/amazing_print/formatters/struct_formatter.rb#72
  def left_aligned; end
end
...
class AmazingPrint::Inspector
  ...
  #
  # source://amazing_print//lib/amazing_print/inspector.rb#29
  def initialize(options = T.unsafe(nil)); end

  # Dispatcher that detects data nesting and invokes object-aware formatter.
  # ---------------------------------------------------------------------------
  #
  # source://amazing_print//lib/amazing_print/inspector.rb#88
  ...
  # @return [Boolean]
  #
  # source://amazing_print//lib/amazing_print/inspector.rb#103
  def colorize?; end

  # source://amazing_print//lib/amazing_print/inspector.rb#78
  def current_indentation; end

  # source://amazing_print//lib/amazing_print/inspector.rb#82
  def increase_indentation(&_arg0); end

  # Returns the value of attribute indentator.
  #
  # source://amazing_print//lib/amazing_print/inspector.rb#16
  def indentator; end
  ...
  # source://amazing_print//lib/amazing_print/inspector.rb#170
  ...
  # ---------------------------------------------------------------------------
  #
  # source://amazing_print//lib/amazing_print/inspector.rb#183
  def load_dotfile; end

  # Load ~/.aprc file with custom defaults that override default options.
  # ---------------------------------------------------------------------------
  #
  # source://amazing_print//lib/amazing_print/inspector.rb#198
  ...
  # ---------------------------------------------------------------------------
  #
  # source://amazing_print//lib/amazing_print/inspector.rb#165
  ...
  # ---------------------------------------------------------------------------
  #
  # source://amazing_print//lib/amazing_print/inspector.rb#128
  ...
  # ---------------------------------------------------------------------------
  #
  # source://amazing_print//lib/amazing_print/inspector.rb#146
  def printable(object); end

  # ---------------------------------------------------------------------------
  #
  # source://amazing_print//lib/amazing_print/inspector.rb#138
  def unnested(object); end

  class << self
    # Unload the cached dotfile and load it again.
    #
    # source://amazing_print//lib/amazing_print/inspector.rb#23
    def reload_dotfile; end
  end
end

# source://amazing_print//lib/amazing_print/inspector.rb#18
AmazingPrint::Inspector::AP = T.let(T.unsafe(nil), Symbol)

# source://amazing_print//lib/amazing_print/json_helper.rb#7
module AmazingPrint::JSONHelper
  # source://amazing_print//lib/amazing_print/json_helper.rb#10
  def json_awesome(object, is_key: T.unsafe(nil)); end
end

# source://amazing_print//lib/amazing_print/json_helper.rb#8
...
module Kernel
  ...
  # source://amazing_print//lib/amazing_print/core_ext/kernel.rb#24
  def amazing_print(object, options = T.unsafe(nil)); end

  # source://amazing_print//lib/amazing_print/core_ext/kernel.rb#18
  ...
  class << self
    # source://amazing_print//lib/amazing_print/core_ext/kernel.rb#26
    def ap(object, options = T.unsafe(nil)); end
  end
end
