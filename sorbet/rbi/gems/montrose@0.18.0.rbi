...
module Montrose
  ...
  class << self
    ...
    #
    # source://montrose//lib/montrose.rb#53
...
module Montrose::Chainable
  ...
  # @return [Montrose::Recurrence]
  #
  # source://montrose//lib/montrose/chainable.rb#276
  ...
  # @return [Montrose::Recurrence]
  #
  # source://montrose//lib/montrose/chainable.rb#155
  ...
  # @return [Montrose::Recurrence]
  #
  # source://montrose//lib/montrose/chainable.rb#308
  ...
  # @return [Montrose::Recurrence]
  #
  # source://montrose//lib/montrose/chainable.rb#260
  ...
  # @return [Montrose::Recurrence]
  #
  # source://montrose//lib/montrose/chainable.rb#324
  ...
  # @return [Montrose::Recurrence]
  #
  # source://montrose//lib/montrose/chainable.rb#354
  ...
  # @return [Montrose::Recurrence]
  #
  # source://montrose//lib/montrose/chainable.rb#141
  ...
  # @return [Montrose::Recurrence]
  #
  # source://montrose//lib/montrose/chainable.rb#292
...
class Montrose::Clock
  ...
  # @private
  #
  # source://montrose//lib/montrose/clock.rb#96
  def current_at_index; end

  # source://montrose//lib/montrose/clock.rb#29
  def next_time(tick); end
  ...
  # @private
  #
  # source://montrose//lib/montrose/clock.rb#65
  def next_time_at(time, tick); end
  ...
  # @private
  #
  # source://montrose//lib/montrose/clock.rb#134
  ...
  # @private
  #
  # source://montrose//lib/montrose/clock.rb#83
  def time_at(time, index); end
  ...
  # @private
  #
  # source://montrose//lib/montrose/clock.rb#120
...
class Montrose::Options
  ...
  # source://montrose//lib/montrose/options.rb#172
  def frequency; end

  # source://montrose//lib/montrose/options.rb#173
  ...
  # source://montrose//lib/montrose/options.rb#132
  def to_h; end
...
class Montrose::Recurrence
  ...
  # source://montrose//lib/montrose/recurrence.rb#216
  ...
  # source://montrose//lib/montrose/recurrence.rb#214
  def length(*args, **_arg1, &block); end

  # source://montrose//lib/montrose/recurrence.rb#215
  ...
  # @since 0.0.1
  #
  # source://montrose//lib/montrose/recurrence.rb#317
  def to_h; end
  ...
  class << self
    ...
    # @since 0.0.1
    #
    # source://montrose//lib/montrose/recurrence.rb#250
...
class Montrose::Rule::NthDayMatcher
  ...
  # source://montrose//lib/montrose/rule/nth_day_matcher.rb#10
...
class Montrose::Schedule
  ...
  # @since 0.0.1
  #
  # source://montrose//lib/montrose/schedule.rb#80
  def add(rule); end
